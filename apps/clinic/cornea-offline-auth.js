...
(function (global) {
  ...
  const ROLE_SECTIONS = Object.freeze({
    administrator: {
      ...
      keratoplasty: true, keratitis_ulcer: true, dry_eye_osd: true, or_scheduling: true, research_analytics: true, appointments_recall: true, kc_registry: true, clinical_media: true, database: true, user_admin: true
    },
    consultant: {
      dashboard: true, patient_form: true, records: true, audit_trail: true, patient_flow: true,
      keratoplasty: true, keratitis_ulcer: true, dry_eye_osd: true, or_scheduling: true, research_analytics: true, appointments_recall: true, kc_registry: true, clinical_media: true, database: false, user_admin: false
    },
    resident: {
      dashboard: true, patient_form: true, records: true, audit_trail: true, patient_flow: true,
      keratoplasty: true, keratitis_ulcer: true, dry_eye_osd: true, or_scheduling: true, research_analytics: true, appointments_recall: true, kc_registry: true, clinical_media: true, database: false, user_admin: false
    ...
    nurse: {
      dashboard: true, patient_form: true, records: true, audit_trail: true, patient_flow: true,
      keratoplasty: false, keratitis_ulcer: true, dry_eye_osd: true, appointments_recall: true, kc_registry: true, clinical_media: true, database: false, user_admin: false
    },
    technician: {
      dashboard: true, patient_form: true, records: true, audit_trail: true, patient_flow: true,
      keratoplasty: false, keratitis_ulcer: true, dry_eye_osd: true, appointments_recall: true, kc_registry: true, clinical_media: true, database: false, user_admin: false
    ...
    receptionist: {
      ...
      keratoplasty: false, keratitis_ulcer: false, dry_eye_osd: false, research_analytics: false, appointments_recall: true, or_scheduling: true, kc_registry: false, clinical_media: false, database: false, user_admin: false
    }
  });
