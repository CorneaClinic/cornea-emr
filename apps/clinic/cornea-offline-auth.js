...
(function (global) {
  ...
  const ROLE_SECTIONS = Object.freeze({
    administrator: {
      ...
      keratoplasty: true, keratitis_ulcer: true, kc_registry: true, clinical_media: true, database: true, user_admin: true
    },
    consultant: {
      dashboard: true, patient_form: true, records: true, audit_trail: true, patient_flow: true,
      keratoplasty: true, keratitis_ulcer: true, kc_registry: true, clinical_media: true, database: false, user_admin: false
    },
    resident: {
      dashboard: true, patient_form: true, records: true, audit_trail: true, patient_flow: true,
      keratoplasty: true, keratitis_ulcer: true, kc_registry: true, clinical_media: true, database: false, user_admin: false
