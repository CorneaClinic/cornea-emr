...
export const PERMISSIONS = Object.freeze({
  ...
  DRY_EYE_READ: 'dry_eye:read',

  DRY_EYE_WRITE: 'dry_eye:write',

  OR_SCHEDULE_READ: 'or_schedule:read',

  OR_SCHEDULE_WRITE: 'or_schedule:write',
...
const CLINICAL_SENIOR = Object.freeze([
  ...
  PERMISSIONS.OR_SCHEDULE_READ,

  PERMISSIONS.OR_SCHEDULE_WRITE,
